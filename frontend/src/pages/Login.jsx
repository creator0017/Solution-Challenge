    ...
    try {
      ...
      switch (error.code) {
        ...
        case 'auth/invalid-credential':
          setErr('No account found for this email. Register free →'); break
        case 'auth/wrong-password':
          setErr('Incorrect password. Try again or reset it.'); break
        case 'auth/too-many-requests':
          setErr('Too many attempts. Please wait a few minutes.'); break
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40 }}>
        <form onSubmit={handleSubmit} style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input className="input" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@company.in" autoComplete="email"/>
          </div>
          ...
          <div style={{ marginBottom: 8 }}>
            ...
            <div style={{ position: 'relative' }}>
              <input className="input" type={show ? 'text' : 'password'} value={pwd} onChange={e => setPwd(e.target.value)} style={{ paddingRight: 44 }} placeholder="Enter your password" autoComplete="current-password"/>
          ...
          <div style={{ textAlign: 'right', marginBottom: 20 }}>
            <span onClick={handleReset} style={{ color: 'var(--teal)', fontSize: 13, fontWeight: 500, cursor: 'pointer' }}>
              Forgot password?
            </span>
          </div>
          ...
          <button className="btn btn-outline" type="button" style={{ width: '100%', height: 44 }} onClick={handleGoogle} disabled={loading || googleLoading}>
